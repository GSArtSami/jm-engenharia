...
import { ArrowLeft, MapPin, Ruler, ChevronLeft, ChevronRight, X, Image } from 'lucide-react';
      ...
      <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#e0e0e0' }}>
        ...
        <div className="flex-grow flex items-center justify-center">
          <Card className="p-8 text-center bg-white">
            <p className="text-gray-500 mb-4">Terreno não encontrado</p>
            <Button onClick={() => navigate('/terrenos')} variant="outline">
